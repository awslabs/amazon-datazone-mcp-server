...
class TestDomainManagement:
    ...
    @pytest.mark.asyncio
    async def test_get_domain_success(self, mcp_server_with_tools, tool_extractor, test_data_helper):
    ...
    @pytest.mark.asyncio
    async def test_get_domain_not_found(self, mcp_server_with_tools, tool_extractor, client_error_helper):
    ...
    @pytest.mark.asyncio
    async def test_create_domain_success(self, mcp_server_with_tools, tool_extractor, sample_domain_data):
    ...
    @pytest.mark.asyncio
    async def test_create_domain_conflict(self, mcp_server_with_tools, tool_extractor, sample_domain_data, client_error_helper):
    ...
    @pytest.mark.asyncio
    async def test_create_domain_access_denied(self, mcp_server_with_tools, tool_extractor, sample_domain_data, client_error_helper):
        ...
        assert f"Access denied while creating domain {sample_domain_data['name']}" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_list_domain_units_success(self, mcp_server_with_tools, tool_extractor, test_data_helper):
        ...
        mcp_server_with_tools._mock_client.list_domain_units_for_parent.assert_called_once_with(
            ...
            parentDomainUnitIdentifier=parent_unit_id
        )

    @pytest.mark.asyncio
    async def test_create_domain_unit_success(self, mcp_server_with_tools, tool_extractor, test_data_helper):
    ...
    @pytest.mark.asyncio
    async def test_get_domain_unit_success(self, mcp_server_with_tools, tool_extractor, test_data_helper):
    ...
    @pytest.mark.asyncio
    async def test_add_policy_grant_success(self, mcp_server_with_tools, tool_extractor, test_data_helper):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_generic_error(self, mcp_server_with_tools, tool_extractor, test_data_helper, client_error_helper):
...
class TestDomainManagementParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_search_with_all_parameters(self, mcp_server_with_tools, tool_extractor, test_data_helper):
