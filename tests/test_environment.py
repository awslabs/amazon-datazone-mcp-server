...
class TestEnvironment:
    ...
    @pytest.mark.asyncio
    async def test_create_connection_access_denied(self, mcp_server_with_tools, tool_extractor, mock_client_error):
        ...
        assert f"Access denied while creating connection in domain {domain_id}" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_environment_not_found(self, mcp_server_with_tools, tool_extractor, mock_client_error):
    ...
    @pytest.mark.asyncio
    async def test_connection_not_found(self, mcp_server_with_tools, tool_extractor, mock_client_error):
...
class TestEnvironmentParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_create_connection_with_optional_params(self, mcp_server_with_tools, tool_extractor):
    ...
    @pytest.mark.asyncio
    async def test_list_environments_max_results_validation(self, mcp_server_with_tools, tool_extractor):
