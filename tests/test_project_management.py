...
class TestProjectManagement:
    ...
    @pytest.mark.asyncio
    async def test_create_project_success(self, mcp_server_with_tools, tool_extractor, sample_project_data):
    ...
    @pytest.mark.asyncio
    async def test_get_project_success(self, mcp_server_with_tools, tool_extractor, test_data_helper):
    ...
    @pytest.mark.asyncio
    async def test_get_project_not_found(self, mcp_server_with_tools, tool_extractor, mock_client_error):
    ...
    async def test_create_project_membership_success(self, mcp_server_with_tools, tool_extractor):
        ...
        # Get the tool function from the MCP server
        create_project_membership = tool_extractor(mcp_server_with_tools, "create_project_membership")
    ...
    @pytest.mark.asyncio
    async def test_create_project_profile_with_environment_config(self, mcp_server_with_tools, tool_extractor):
    ...
    @pytest.mark.asyncio
    async def test_create_project_profile_access_denied(self, mcp_server_with_tools, tool_extractor, mock_client_error):
        ...
        assert f"Access denied while creating project profile '{profile_name}'" in str(exc_info.value)

    @pytest.mark.asyncio
    async def test_create_project_access_denied(self, mcp_server_with_tools, tool_extractor, mock_client_error):
...
class TestProjectManagementParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_create_project_with_all_optional_params(self, mcp_server_with_tools, tool_extractor):
    ...
    @pytest.mark.asyncio
    async def test_list_projects_max_results_validation(self, mcp_server_with_tools, tool_extractor):
