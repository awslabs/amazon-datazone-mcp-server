...
class TestGlossary:
    ...
    @pytest.mark.asyncio
    async def test_create_glossary_success(self, mcp_server_with_tools, tool_extractor, sample_glossary_data):
    ...
    @pytest.mark.asyncio
    async def test_create_glossary_access_denied(self, mcp_server_with_tools, tool_extractor, mock_client_error):
    ...
    @pytest.mark.asyncio
    async def test_glossary_not_found(self, mcp_server_with_tools, tool_extractor, mock_client_error):
    ...
    @pytest.mark.asyncio
    async def test_create_glossary_term_conflict(self, mcp_server_with_tools, tool_extractor, mock_client_error):
...
class TestGlossaryParameterValidation:
    ...
    @pytest.mark.asyncio
    async def test_create_glossary_with_optional_params(self, mcp_server_with_tools, tool_extractor):
    ...
    @pytest.mark.asyncio
    async def test_create_glossary_term_with_optional_params(self, mcp_server_with_tools, tool_extractor):
