...
def register_tools(mcp: FastMCP):
    ...
    async def get_asset(
        ...
        try:
            ...
            raise Exception(f"Error getting asset {asset_identifier} in domain {domain_identifier}: {e}")
    ...
    async def create_asset(
        ...
        forms_input: List[Dict[str, str]] = None,
        ...
        try:
            ...
            raise Exception(f"Error creating asset in domain {domain_identifier}: {e}")
    ...
    async def get_listing(
        ...
        try:
            ...
            raise Exception(f"Error getting listing {identifier} in domain {domain_identifier}: {e}")
